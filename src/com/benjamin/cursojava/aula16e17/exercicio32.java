...
public class exercicio32 {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println("Digite o código precione enter e digite a quantidada. Ou 0 enter 0 para sair: ");
			cod = scan.nextInt();
			qtd = scan.nextInt();
			...
			if (cod == 0 && qtd == 0) {
				...
				if (cod == 100) {
					...
					output += "Hambuerquer -> 1,20 * " + qtd;
					output += " = " + (1.2 * qtd) + "\n";
					total += 1.2 * qtd;
				} else if (cod == 104) {
					output += "Cheeseburquer -> 1,30 * " + qtd;
					output += " = " + (1.3 * qtd) + "\n";
					total += 1.3 * qtd;
				} else if (cod == 105) {
